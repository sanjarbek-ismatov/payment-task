...
function SideBar() {
    return (
        <>
            <aside
                id="logo-sidebar"
                className="z-40 lg:w-64  mr-4 h-screen pt-5  bg-white border-r border-gray-200 md:block hidden dark:bg-gray-900 dark:border-gray-800"
                aria-label="Sidebar"
            >
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            >
                                ...
                                <span className="ml-3 hidden lg:inline">Asosiy</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ml-3 hidden lg:inline">O'tkazish</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ml-3 hidden lg:inline">Hisobotlar</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ml-3 hidden lg:inline">Sozlamalar</span>
                            </Link>
                        </li>
                    </ul>
                </div>
