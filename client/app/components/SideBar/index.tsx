...
function SideBar() {
  return (
    <>
      <aside
        id="logo-sidebar"
        className="z-40 w-64 h-screen pt-5 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-900 dark:border-gray-800"
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">Hisobotlar</span>
              </Link>
            </li>
            <li>
              <Link
